...
external interface JQueryStatic {
    ...
    var Event: JQuery.EventStatic
    var cssHooks: JQuery.PlainObject<JQuery.CSSHook<HTMLElement>>
    var cssNumber: JQuery.PlainObject<Boolean>
    var fn: JQuery<HTMLElement>
    var fx: `T$0`
    var ready: JQuery.Thenable<JQueryStatic>
    var support: JQuery.PlainObject<Any>
    var valHooks: JQuery.PlainObject<JQuery.ValHook<HTMLElement>>
    @nativeInvoke
    operator fun invoke(window: Window, discriminator: Boolean): JQueryStatic
    @nativeInvoke
    operator fun <TElement : HTMLElement> invoke(html: String, ownerDocument_attributes: JQuery.PlainObject<Any>? = definedExternally /* null */): JQuery<TElement>
    @nativeInvoke
    operator fun <TElement : HTMLElement> invoke(html: String, ownerDocument_attributes: Document? = definedExternally /* null */): JQuery<TElement>
    @nativeInvoke
    operator fun <TElement : Element> invoke(selector: String, context: Element? = definedExternally /* null */): JQuery<TElement>
    @nativeInvoke
    operator fun <TElement : Element> invoke(selector: String, context: JQuery<HTMLElement>? = definedExternally /* null */): JQuery<TElement>
    @nativeInvoke
    operator fun <TElement : Element> invoke(selector: String, context: Document? = definedExternally /* null */): JQuery<TElement>
    @nativeInvoke
    operator fun <T : Element> invoke(element_elementArray: T): JQuery<T>
    @nativeInvoke
    operator fun <T : Element> invoke(element_elementArray: ArrayLike<T>): JQuery<T>
    @nativeInvoke
    operator fun <T> invoke(selection: JQuery<T>): JQuery<T>
    @nativeInvoke
    operator fun <TElement> invoke(callback: (`this`: Document, `$`: JQueryStatic) -> Unit): JQuery<TElement>
    @nativeInvoke
    operator fun <T : JQuery.PlainObject<Any>> invoke(`object`: T): JQuery<T>
    @nativeInvoke
    operator fun <TElement> invoke(): JQuery<TElement>
    ...
    fun <T, TReturn> map(array: Array<T>, callback: (`this`: Window, elementOfArray: T, indexInArray: Number) -> dynamic /* TReturn | Array<TReturn> */): Array<TReturn>
    fun <T, K : Any?, TReturn> map(obj: T, callback: (`this`: Window, propertyOfObject: Any?, key: K) -> dynamic /* TReturn | Array<TReturn> */): Array<TReturn>
    fun <T, U> merge(first: ArrayLike<T>, second: ArrayLike<U>): Array<dynamic /* T | U */>
    fun noConflict(removeAll: Boolean? = definedExternally /* null */): JQueryStatic /* this */
    fun noop(): Nothing?
    fun now(): Number
    ...
    fun parseHTML(data: String, context: Document?, keepScripts: Boolean): Array<dynamic /* Element | Text | Comment | DocumentFragment */>
    fun parseHTML(data: String, context_keepScripts: Boolean? = definedExternally /* null */): Array<dynamic /* Element | Text | Comment | DocumentFragment */>
    fun parseHTML(data: String, context_keepScripts: Document? = definedExternally /* null */): Array<dynamic /* Element | Text | Comment | DocumentFragment */>
    fun parseHTML(data: String, context_keepScripts: Nothing? = definedExternally /* null */): Array<dynamic /* Element | Text | Comment | DocumentFragment */>
    ...
    fun <TElement : Element> speed(duration: Number, easing: String, complete: (`this`: TElement) -> Unit): JQuery.EffectsOptions<TElement>
    fun <TElement : Element> speed(duration: String /* "fast" */, easing: String, complete: (`this`: TElement) -> Unit): JQuery.EffectsOptions<TElement>
    fun <TElement : Element> speed(duration: String /* "slow" */, easing: String, complete: (`this`: TElement) -> Unit): JQuery.EffectsOptions<TElement>
    fun <TElement : Element> speed(duration: Number, easing_complete: String): JQuery.EffectsOptions<TElement>
    fun <TElement : Element> speed(duration: Number, easing_complete: (`this`: TElement) -> Unit): JQuery.EffectsOptions<TElement>
    fun <TElement : Element> speed(duration: String /* "fast" */, easing_complete: String): JQuery.EffectsOptions<TElement>
    fun <TElement : Element> speed(duration: String /* "fast" */, easing_complete: (`this`: TElement) -> Unit): JQuery.EffectsOptions<TElement>
    fun <TElement : Element> speed(duration: String /* "slow" */, easing_complete: String): JQuery.EffectsOptions<TElement>
    fun <TElement : Element> speed(duration: String /* "slow" */, easing_complete: (`this`: TElement) -> Unit): JQuery.EffectsOptions<TElement>
    fun <TElement : Element> speed(duration_complete_settings: Number? = definedExternally /* null */): JQuery.EffectsOptions<TElement>
    fun <TElement : Element> speed(duration_complete_settings: String? /* "fast" */ = definedExternally /* null */): JQuery.EffectsOptions<TElement>
    fun <TElement : Element> speed(duration_complete_settings: String? /* "slow" */ = definedExternally /* null */): JQuery.EffectsOptions<TElement>
    fun <TElement : Element> speed(duration_complete_settings: ((`this`: TElement) -> Unit)? = definedExternally /* null */): JQuery.EffectsOptions<TElement>
    fun <TElement : Element> speed(duration_complete_settings: JQuery.SpeedSettings<TElement>? = definedExternally /* null */): JQuery.EffectsOptions<TElement>
    ...
    @nativeInvoke
    operator fun <TElement : HTMLElement> invoke(html: String): JQuery<TElement>
    @nativeInvoke
    operator fun <TElement : Element> invoke(selector: String): JQuery<TElement>
    fun get(): JQuery.jqXHR<Any>
    fun getJSON(url: String): JQuery.jqXHR<Any>
    fun parseHTML(data: String): Array<dynamic /* Element | Text | Comment | DocumentFragment */>
    fun post(): JQuery.jqXHR<Any>
    fun <T : Element> queue(element: T): `T$1` /* `T$1` & Array<JQuery.QueueFunction<T>> */
    fun <TElement : Element> speed(): JQuery.EffectsOptions<TElement>
}
...
external interface JQuery<TElement> : Iterable<TElement> {
    var jquery: String
    var length: Number
    ...
    fun after(vararg contents: DocumentFragment): JQuery<TElement> /* this */
    fun after(vararg contents: JQuery<dynamic /* Element | Text | Comment | DocumentFragment */>): JQuery<TElement> /* this */
    fun after(vararg contents: Array<dynamic /* Element | Text | Comment | DocumentFragment | JQuery<dynamic /* Element | Text | Comment | DocumentFragment */> */>): JQuery<TElement> /* this */
    fun after(fn: (`this`: TElement, index: Number, html: String) -> dynamic /* String | Element | Text | Comment | DocumentFragment | JQuery<dynamic /* Element | Text | Comment | DocumentFragment */> | Array<dynamic /* Element | Text | Comment | DocumentFragment | JQuery<dynamic /* Element | Text | Comment | DocumentFragment */> */> */): JQuery<TElement> /* this */
    ...
    fun append(vararg contents: DocumentFragment): JQuery<TElement> /* this */
    fun append(vararg contents: JQuery<dynamic /* Element | Text | Comment | DocumentFragment */>): JQuery<TElement> /* this */
    fun append(vararg contents: Array<dynamic /* Element | Text | Comment | DocumentFragment | JQuery<dynamic /* Element | Text | Comment | DocumentFragment */> */>): JQuery<TElement> /* this */
    fun append(fn: (`this`: TElement, index: Number, html: String) -> dynamic /* String | Element | Text | Comment | DocumentFragment | JQuery<dynamic /* Element | Text | Comment | DocumentFragment */> | Array<dynamic /* Element | Text | Comment | DocumentFragment | JQuery<dynamic /* Element | Text | Comment | DocumentFragment */> */> */): JQuery<TElement> /* this */
    ...
    fun before(vararg contents: DocumentFragment): JQuery<TElement> /* this */
    fun before(vararg contents: JQuery<dynamic /* Element | Text | Comment | DocumentFragment */>): JQuery<TElement> /* this */
    fun before(vararg contents: Array<dynamic /* Element | Text | Comment | DocumentFragment | JQuery<dynamic /* Element | Text | Comment | DocumentFragment */> */>): JQuery<TElement> /* this */
    fun before(fn: (`this`: TElement, index: Number, html: String) -> dynamic /* String | Element | Text | Comment | DocumentFragment | JQuery<dynamic /* Element | Text | Comment | DocumentFragment */> | Array<dynamic /* Element | Text | Comment | DocumentFragment | JQuery<dynamic /* Element | Text | Comment | DocumentFragment */> */> */): JQuery<TElement> /* this */
    ...
    fun insertAfter(target: Node): JQuery<TElement> /* this */
    fun insertAfter(target: Array<Node>): JQuery<TElement> /* this */
    fun insertAfter(target: JQuery<Node>): JQuery<TElement> /* this */
    fun insertBefore(target: String): JQuery<TElement> /* this */
    fun insertBefore(target: Node): JQuery<TElement> /* this */
    fun insertBefore(target: Array<Node>): JQuery<TElement> /* this */
    fun insertBefore(target: JQuery<Node>): JQuery<TElement> /* this */
    ...
    fun <TReturn> map(callback: (`this`: TElement, index: Number, domElement: TElement) -> dynamic /* TReturn | Array<TReturn> */): JQuery<TReturn>
    ...
    fun offset(coordinates: Any?): JQuery<TElement> /* this */
    fun offset(coordinates: `T$2`): JQuery<TElement> /* this */
    fun offset(coordinates: (`this`: TElement, index: Number, coords: JQuery.Coordinates) -> dynamic /* Any? | `T$2` */): JQuery<TElement> /* this */
    ...
    fun on(events: String, selector: String?, data: Any, handler: (event: JQueryEventObject) -> Unit): JQuery<TElement> /* this */
    ...
    fun on(events: String, selector: String, handler: (event: JQueryEventObject) -> Unit): JQuery<TElement> /* this */
    ...
    fun on(events: String, data: Any, handler: (event: JQueryEventObject) -> Unit): JQuery<TElement> /* this */
    ...
    fun on(events: String, handler: (event: JQueryEventObject) -> Unit): JQuery<TElement> /* this */
    ...
    fun prepend(vararg contents: DocumentFragment): JQuery<TElement> /* this */
    fun prepend(vararg contents: JQuery<dynamic /* Element | Text | Comment | DocumentFragment */>): JQuery<TElement> /* this */
    fun prepend(vararg contents: Array<dynamic /* Element | Text | Comment | DocumentFragment | JQuery<dynamic /* Element | Text | Comment | DocumentFragment */> */>): JQuery<TElement> /* this */
    fun prepend(fn: (`this`: TElement, index: Number, html: String) -> dynamic /* String | Element | Text | Comment | DocumentFragment | JQuery<dynamic /* Element | Text | Comment | DocumentFragment */> | Array<dynamic /* Element | Text | Comment | DocumentFragment | JQuery<dynamic /* Element | Text | Comment | DocumentFragment */> */> */): JQuery<TElement> /* this */
    ...
    fun ready(handler: (`$`: JQueryStatic) -> Unit): JQuery<TElement> /* this */
...
external interface JQueryEventConstructor : JQuery.EventStatic
